...
class PubmedFTPHandler {
    companion object {
        ...
        // change number for current year value
        fun pubmedFileToId(name: String): Int = name.removeSurrounding("pubmed21n", ".xml.gz").toInt()

        fun idToPubmedFile(id: Int): String = "pubmed21n${id.toString().padStart(4, '0')}.xml.gz"
    }

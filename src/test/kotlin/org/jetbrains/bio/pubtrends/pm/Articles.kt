...
object Articles {
    val articles = mapOf(
            ...
            622131 to PubmedArticle(
                    pmid = 622131,
                    date = DateTime(1978, 2, 23, 12, 0),
                    title = "Clofibrate and gallbladder disease",
                    auxInfo = ArticleAuxInfo(
                            authors = listOf(
                                    Author(
                                            name = "Coronary Drug Project Research Group",
                                            affiliation = listOf(
                                                    "University of Maryland, Baltimore, MD 21210"
                                            )
                                    )
                            )
                    )

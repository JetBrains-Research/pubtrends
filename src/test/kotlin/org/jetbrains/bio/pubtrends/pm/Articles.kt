...
object Articles {
    val articles = mapOf(
            420880 to PubmedArticle(420880).apply {
                year = 1979
                ...
                meshHeadingList.addAll(listOf("Aging", "Animals", "Animals Newborn", "Brain growth & development metabolism",
                ...
                auxInfo.databanks.addAll(listOf(
                        DatabankEntry(name = "GENBANK",
                                accessionNumber = mutableListOf("AF321191", "AF321192")),
                        DatabankEntry(name = "OMIM",
                                accessionNumber = mutableListOf("118200", "145900", "162500", "605253"))
                ))
                auxInfo.journal.name = "Biokhimiia (Moscow, Russia)"
                auxInfo.language = "rus"
            },

            29736257 to PubmedArticle(29736257).apply {
                year = 2017
            ...
            29456534 to PubmedArticle(29456534).apply {
                year = 2018
                ...
                auxInfo.authors.addAll(listOf(
                        Author("Freudenberg K", mutableListOf("Molecular and Cellular Immunology/Immune Regulation, " +
                        ...
                        Author("Dohnke S", mutableListOf("Molecular and Cellular Immunology/Immune Regulation, " +
                        "DFG-Center for Regenerative Therapies Dresden (CRTD), Center for Molecular and Cellular" +
                        " Bioengineering (CMCB), Technische Universität Dresden, Dresden, Germany", "Osteoimmunology," +
                        " DFG-Center for Regenerative Therapies Dresden (CRTD), Center for Molecular and Cellular " +
                        "Bioengineering (CMCB), Technische Universität Dresden, Dresden, Germany"))))
            },

            20453483 to PubmedArticle(20453483).apply {
                year = 2011
            ...
            27654823 to PubmedArticle(27654823).apply {
                year = 2017
            ...
            11243089 to PubmedArticle(11243089).apply {
                year = 1999
            ...
            11540070 to PubmedArticle(11540070).apply {
                year = 1987
            ...
            10188493 to PubmedArticle(10188493).apply {
                year = 1998
                title = "Women's health osteopathy: an alternative view"
            },

            14316043 to PubmedArticle(14316043).apply {
                year = 1965
            ...
            18122624 to PubmedArticle(18122624).apply {
                year = 1947
                title = "Mesenteric vascular occlusion"
                keywordList.add("MESENTERY occlusion")
            },

            24884411 to PubmedArticle(24884411).apply {
                year = 2014
            ...
            29391692 to PubmedArticle(29391692).apply {
                year = 2017

...
class KeyPaperAnalyzer:
    ...
    def launch(self, *terms, task=None):
        ...
        try:
            ...
            self.cit_df = self.build_cit_df(cit_stats_df_from_query, self.n_papers, current=3.5, task=task)
            ...
            self.cocit_df, cocit_grouped_df = self.loader.load_cocitations(current=4, task=task)

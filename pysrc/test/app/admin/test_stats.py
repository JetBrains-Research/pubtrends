...
EXPECTED_STATS = {
    'total_terms_searches': 2,
    'total_paper_searches': 2,
    'recent_searches': [
        ('2021-10-07 14:46:24',
         'Semantic Scholar',
         'Bla-bla-bla',
         '/result?query=Bla-bla-bla&source=Semantic Scholar&jobid=23818aa8',
         '00:05:42', 'Not found',
         '-', '-'),
        ('2021-10-06 14:06:57',
         'Pubmed',
         'human microbiome',
         '/result?query=human microbiome&source=Pubmed&jobid=fce96ec4',
         '06:02:16', 'Ok', '+',
         '+')],
    'recent_papers': [
        (
            ...
            '/paper?query=Paper doi=10.1063/5.0021420&analysis_type=paper&source=Semantic Scholar&key=doi&'
            'value=10.1063/5.0021420&jobid=96584252',
            '00:03:59',
            'Ok'),
        ('2021-10-07 04:34:42',
         'Pubmed',
         'Paper title',
         '/paper?query=Paper title&analysis_type=paper&key=title&value=On the features of ...&source=Pubmed&'
         'jobid=400a5897',
         '-',
         'N/A')],
    'successful_searches': 2,
    'searches_avg_duration': '03:03:59',
    'searches_papers_shown': 1,
    'searches_graph_shown': 1,
    'paper_successful_searches': 1,

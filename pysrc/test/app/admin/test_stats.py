...
EXPECTED_STATS = {'paper_searches_avg_duration': '00:03:59', 'paper_searches_recent': [
    ('2021-10-12 09:12:49', 'Semantic Scholar', 'Paper doi=10.1063/5.0021420',
     '/paper?query=Paper doi=10.1063/5.0021420&analysis_type=paper&source=Semantic Scholar&key=doi&value=10.1063/5.0021420&jobid=96584252',
     '00:03:59', 'Ok'), ('2021-10-07 04:34:42', 'Pubmed', 'Paper title',
                         '/paper?query=Paper title&analysis_type=paper&key=title&value=On the features of ...&source=Pubmed&jobid=400a5897',
                         '-', 'N/A')], 'paper_searches_successful': 1, 'paper_searches_total': 2, 'recent': 50,
                  'searches_graph_shown': 1, 'searches_papers_clicks': 1, 'searches_papers_list_shown': 1,
                  'terms_searches_avg_duration': '00:05:42', 'terms_searches_recent': [
        ('2021-10-07 14:46:24', 'Semantic Scholar', 'Bla-bla-bla',
         '/result?query=Bla-bla-bla&source=Semantic Scholar&jobid=23818aa8', '00:05:42', 'Not found', 0, '-', '-'),
        ('2021-10-06 14:06:57', 'Pubmed', 'human microbiome',
         '/result?query=human microbiome&source=Pubmed&jobid=fce96ec4', '-', 'N/A', 1, '+', '+')],
                  'terms_searches_successful': 1, 'terms_searches_total': 2}

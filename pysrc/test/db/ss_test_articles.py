...
article1 = SemanticScholarArticle('5451b1ef43678d473575bdfa7016d024146f2b53', -410264312,
                                  'I can find this using full text search',
                                  year=1999, doi='10.000/0000')

article2 = SemanticScholarArticle('cad767094c2c4fff5206793fd8674a10e7fba3fe', 984465402,
                                  'Can find using search',
                                  year=1980)

article3 = SemanticScholarArticle('e7cdbddc7af4b6138227139d714df28e2090bd5f', 17079054,
                                  'Use search to find it')

article4 = SemanticScholarArticle('3cf82f53a52867aaade081324dff65dd35b5b7eb', -1875049083,
                                  'Want to find it? Just search', year=1976)

article5 = SemanticScholarArticle('5a63b4199bb58992882b0bf60bc1b1b3f392e5a5', 1831680518,
                                  'Search is key to find',
                                  year=2003)

article6 = SemanticScholarArticle('7dc6f2c387193925d3be92d4cc31c7a7cea66d4e', -1626578460,
                                  'Article 6 is here',
                                  year=2018)

article7 = SemanticScholarArticle('0f9c1d2a70608d36ad7588d3d93ef261d1ae3203', 1075821748,
                                  'Article 7 is here',
                                  year=2010)

article8 = SemanticScholarArticle('872ad0e120b9eefd334562149c065afcfbf90268', -1861977375,
                                  'Article 8 is here',
                                  year=1937)

article9 = SemanticScholarArticle('89ffce2b5da6669f63c99ff6398b312389c357dc', -1190899769,
                                  'Article 9 is here')

article10 = SemanticScholarArticle('390f6fbb1f25bfbc53232e8248c581cdcc1fb9e9', -751585733,
                                   'Article 10 is here',
                                   year=2017,
                                   type='Review')
